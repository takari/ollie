...
import com.walmartlabs.ollie.toml.TomlParser.*;
...
public final class Toml {
   ...
   *
   * @param in an input stream containing a toml document
   * @return an unnamed root {@link KeyGroup} containing the top level key value pairs and key
