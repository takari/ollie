...
import static com.walmartlabs.ollie.util.Util.concat;
import static com.walmartlabs.ollie.util.Util.indexOf;
import static com.walmartlabs.ollie.util.Util.intersect;
import static com.walmartlabs.ollie.util.Util.nonEmptyIntersection;
...
public final class ConnectionSpec {
  ...
  public List<String> cipherSuites() {    
    return Lists.newArrayList(cipherSuites);
  }
  ...
  public static void main(String[] args) {
    for(String s : ConnectionSpec.MODERN_TLS.cipherSuites()) {
