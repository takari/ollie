...
public class ConfigurationModule extends AbstractModule {
  ...
  private ConfigurationModule(com.typesafe.config.Config config, Reflections reflections) {
    this.config = config;
   ...
   */
  public static ConfigurationModule fromConfigWithPackage(com.typesafe.config.Config config, String packageNamePrefix) {
    ...
    return new ConfigurationModule(config, reflections);
  }
